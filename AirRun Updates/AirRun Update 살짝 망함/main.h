...
#define MUSICS 9
#define BULLETLEVELS 10
#define ITEMKINDS 2

typedef struct{
        char initFileName[FILENAMELEN];
        char musicNames[MUSICS][FILENAMELEN];
        char playerBitName[FILENAMELEN];
        char enemyBitName[FILENAMELEN];
        char explosionBitName[FILENAMELEN];
        char bulletBitNames[BULLETLEVELS][FILENAMELEN];
        char itemBitNames[ITEMKINDS][FILENAMELEN];
}Setting;
